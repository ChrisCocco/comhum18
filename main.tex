...
\begin{figure}[h!]
	...
	\caption{Distribution of identified colours.{\color{green}[AX: je propose de supprimer le titre de l'axe des x et remplacer celui des y par "Proportion of pixels". Aussi, est-ce possible d'agrandir encore un peu la police des etiquettes de l'axe des x, pour les vieux comme moi? ;) Mais ca peut attendre la version finale.]}}
...
\begin{figure}[h!]
	...
	\caption{Distribution of colour variety.{\color{green}[AX: je supprimerais "rate" dans le titre de l'axe des y, et je noterais "Colour variety" au lieu de V dans celui des x.]}}
