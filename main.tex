...
\maketitle
\begin{abstract}
[To update] Children's drawings reveal that developing colour retrieval technics
...
In computer vision, there are well developed techniques to analyse and retrieve natural images (e.g.~pictures or videos); whereas the status of the
...
%\hypertarget{colour-perception}{%
%\section{Colour perception}\label{colour-perception}}
